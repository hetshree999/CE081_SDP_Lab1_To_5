...
void main() {
  ...
  /* Comments
  //output of above line will be : Welcome to the world of Dart.
  //This is single line comment . This will not going to execute
  /* This is multiline comments
  This also will not going to execute
  Dart also allows the nested comments
   */

   ///documentation comments can be single line or multi line.
   /**This is multi line documentation comments */

   */
  
  /************Statements and expressions***********
  // Statement is a command, something you tell computer to do.
 ...
 */
  ...
  /************Expressions*************/
  //3 +2; //This line will not giv error.
  // 22~/7 => This operator (~/) will perform integer division.
  // This is called truncating division operator.
  // And this produces result 3
  // Euclidean modulo operation (%)
  // 28 % 10 => result of this is 8
  //Order of operation
  ...
  // truncating division and modulo operation have same precedence as multiplication and division
  // Math functions
  // to use math functions we need to import core library named "dart:math"
  /*
...
//Naming Data
//Identifiers cannot contains keywords.
 //Valid Identifers
//  String firstName;
//  String first_name;
//  int num1;
...
//  int Var;
//Idetifiers cannot contain spaces.
//They must be unique.
...
// A gog name specifically describes the role of a variable or constants.
Examples are: personAge, numberOfPeople, gradePointAverage

//Often a bad name is simply not descriptive enough. Here are
some examples of bad names:
a , temp, average
//Also, note how the names above are written. In Dart, it’s
standard to use lowerCamelCase for variable and constant
...
// Increment and Decrement 
  ...
  myValue *= 5; // same as myValue = myValue * 3; // myValue = 30.0;
  print(myValue);
  myValue /= 6; // same as myValue = myValue / 2; // myValue = 15.0;
  print(myValue);
*/
